<html>
<link href="projUI.css" rel="stylesheet" />
<body>
	<form>
<?php
//DECLARE VARIABLES
...
$sql = "SELECT * FROM charity_key WHERE username='$_POST[username]'
	AND password=SHA2('$_POST[pswd]',256)
	" ;
...
if($count==1){
	...
	header("location: charitymember.php");
	 } else{
...
<div class="header">
  <h1 color=blue><font color= "white">Welcome to The Usiwaste Initiative</font></h1>
</div>
...
<p>  
The Usiwaste Initiative is here to helpyou better manage your food waste through redistribution to charities.
</p>  
</body>  
</html>
