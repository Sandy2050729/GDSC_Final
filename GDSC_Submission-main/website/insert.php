...
$expiry = mysqli_real_escape_string($link, $_REQUEST['expiry']);
$quantity = mysqli_real_escape_string($link, $_REQUEST['quantity']);
// Attempt insert query execution
$sql = "INSERT INTO items (item_type, brand, expiry, quantity) VALUES ('$item_type', '$brand', '$expiry', '$quantity')";
...
<a href="insert.html" class="btn btn-lg">Add product</button></br>
