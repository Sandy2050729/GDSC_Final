<html>
<link href="projUIForm.css" rel="stylesheet" />
<body>
<form>
<?php
//DECLARE VARIABLES
...
if($bname=="" or $name=="" or $contact=="" or $email=="" or $address=="" or $county=="" or $username=="" or $pswd==""){
...
//INSERT INTO TABLE donor_key: name, Password, Username
$sql = "INSERT INTO donor_key VALUES(
 '$_POST[username]',
 SHA2('$_POST[pswd]',256)
)" ;
...
//INSERT INTO TABLE donor_general_info: bname, name, address, Date_of_Employment
$sql2 = "INSERT INTO donor_general_info VALUES(
  '$_POST[bname]',
 '$_POST[name]',
 '$_POST[address]',
  '$_POST[county]'
...
//INSERT INTO TABLE donor_details: contact, email
$sql3 = "INSERT INTO donor_details VALUES(
 '$_POST[contact]',
 '$_POST[email]'
)" ;
...
echo "Record for $_POST[name] added successfully";
echo '<br/><a href="donorlogin.html">Login Page</a>';
